...
class FirebaseAccountDataSource implements AccountDataSource {
  ...
  FirebaseAccountDataSource(this.fAuth, this.fStore, this.fStorage);
  ...
  Future<void> resetPassword(String email) {
    return fAuth.sendPasswordResetEmail(email: email);
  }

  @override
  Future<UserEntity> signIn(String email, String password) async {
    var fUser = await fAuth.signInWithEmailAndPassword(
  ...
  Future<UserEntity> updateAccount(UserEntity user) async {
    var fUserTemp = await fAuth.currentUser().then((fuser) {
  ...
  Future<UserEntity> updatePassword(
    ...
    var user = await fAuth.currentUser();
  ...
  Future<UserEntity> signInWithGoogle(GoogleSignInAccount currentUser) async {
    ...
    var user = _adapterFirebaseUserToUser(await fAuth.linkWithCredential(
